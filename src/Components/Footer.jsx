...
function Footer() {
  return (
        ...
        <div className="mb-9 flex justify-center items-center">
           ...
           <a className="mr-9 text-neutral-200 ">
            <Link to="https://www.facebook.com">
             ...
             >
                <path
                    d="M24 12.07C24 5.41 18.63 0 12 0S0 5.4 0 12.07C0 18.1 4.39 23.1 10.13 24v-8.44H7.08v-3.49h3.04V9.41c0-3.02 1.8-4.7 4.54-4.7 1.31 0 2.68.24 2.68.24v2.97h-1.5c-1.5 0-1.96.93-1.96 1.89v2.26h3.32l-.53 3.5h-2.8V24C19.62 23.1 24 18.1 24 12.0"
                />
             </svg>
             </Link>    
           </a>
           ...
           <Link to="https://www.youtube.com">
             ...
             >
                <path
                    d="M12.04 3.5c.59 0 7.54.02 9.34.5a3.02 3.02 0 0 1 2.12 2.15C24 8.05 24 12 24 12v.04c0 .43-.03 4.03-.5 5.8A3.02 3.02 0 0 1 21.38 20c-1.76.48-8.45.5-9.3.51h-.17c-.85 0-7.54-.03-9.29-.5A3.02 3.02 0 0 1 .5 17.84c-.42-1.61-.49-4.7-.5-5.6v-.5c.01-.9.08-3.99.5-5.6a3.02 3.02 0 0 1 2.12-2.14c1.8-.49 8.75-.51 9.34-.51zM9.54 8.4v7.18L15.82 12 9.54 8.41"
                />
             </svg>
             </Link>    
           </a> 
    ...
    {/*Now For Copyright Elements */}
    <div className="text-gray-200 text-center p-4">
    © 2024 Copyright: 
    <a 
        className ="p-2"
        href="http://github.com/CoughKing">
        CoughKing
    </a>
    </div>
